...
class Config:
    ...
    SCAN_INTERVAL_SEC            = _p("SCAN_INTERVAL_SEC",           600)
    MANAGER_INTERVAL_SEC         = _p("MANAGER_INTERVAL_SEC",        5)
    WATCHLIST_CHECK_INTERVAL_SEC = _p("WATCHLIST_CHECK_INTERVAL_SEC", 60)

    # ── Module 2 — TRIGGER (Pure Price Action) ───────────────────────
    TIMEFRAME                    = _p("TIMEFRAME",                   "4h")
    BB_LENGTH                    = 20
    BB_STD                       = 2.0
    ...
    GREEN_LOSS_MIN_BODY_PCT      = _p("GREEN_LOSS_MIN_BODY_PCT",     2.0)
